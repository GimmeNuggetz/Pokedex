...
var PokemonIndex = function PokemonIndex(props) {
  var pokeNames = props.pokemon.map(function (el) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      key: el.id
    }, el.name, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("img", {
      src: el.image_url
    }));
  });
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, pokeNames);
};
...
/***/ "./frontend/components/pokemon/pokemon_index_container.jsx":
/*!*****************************************************************!*\
  !*** ./frontend/components/pokemon/pokemon_index_container.jsx ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _reducers_selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../reducers/selectors */ "./frontend/reducers/selectors.js");
...
var mapStateToProps = function mapStateToProps(monkeys) {
  // const pokemon = selectAllPokemon(state)
  return {
    pokemon: Object(_reducers_selectors__WEBPACK_IMPORTED_MODULE_0__["selectAllPokemon"])(monkeys)
  };
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    requestAllPokemon: dispatch(_actions_pokemon_actions__WEBPACK_IMPORTED_MODULE_1__["requestAllPokemon"])
  };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["connect"])(mapStateToProps, mapDispatchToProps)(_pokemon_index__WEBPACK_IMPORTED_MODULE_2__["default"]));
...
/* harmony import */ var _pokemon_pokemon_index_container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pokemon/pokemon_index_container */ "./frontend/components/pokemon/pokemon_index_container.jsx");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.store = store; // window.store().getState(); // should return initial app state

  window.store.dispatch(Object(_actions_pokemon_actions__WEBPACK_IMPORTED_MODULE_4__["requestAllPokemon"])());
});
...
var configureStore = function configureStore() {
  ...
  return Object(redux__WEBPACK_IMPORTED_MODULE_0__["createStore"])(_reducers_root_reducer__WEBPACK_IMPORTED_MODULE_3__["default"], preloadedState, Object(redux__WEBPACK_IMPORTED_MODULE_0__["applyMiddleware"])(_middleware_thunk__WEBPACK_IMPORTED_MODULE_2__["default"], redux_logger__WEBPACK_IMPORTED_MODULE_1___default.a));
};
...
/*!***********************************!*\
  !*** ./frontend/util/api_util.js ***!
  \***********************************/
/*! exports provided: fetchAllPokemon, fetchPoke */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchAllPokemon", function() { return fetchAllPokemon; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchPoke", function() { return fetchPoke; });
...
var fetchPoke = function fetchPoke(poke) {
  return $.ajax({
    url: "/api/pokemon/".concat(poke.id),
    method: "GET"
  });
};
